...
_ROUTER_INSTRUCTIONS = (
    ...
    "product_question (pergunta sobre produtos), regulatory_question (pergunta sobre "
    "regulação de crédito, Open Finance, proteção ao consumidor ou proteção de dados), "
    "loan_simulation (quer simular um empréstimo), profile_analysis (quer uma análise "
    "do seu perfil financeiro), complaint (reclamação), ou out_of_scope (fora do escopo "
    "do assistente).\n\n"
